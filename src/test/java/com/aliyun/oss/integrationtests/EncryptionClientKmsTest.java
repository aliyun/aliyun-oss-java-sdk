...
public class EncryptionClientKmsTest extends TestBase {
    ...
    public void setUp() throws Exception {
        ...
        kmsRegion = TestConfig.OSS_TEST_REGION;
    ...
    public void testPutObjectFromFile() {
        try {
            String key = "encryption-client-test-put-get-file";
    ...
    public void testFindKeyByDescirtion() throws Throwable {
        try {
            ...
            String newRegion = TestConfig.OSS_TEST_REGION2;
            String newCmkId = TestConfig.OSS_TEST_REGION2_CMK;
            ...
            encryptionMaterials.addRegionDescMaterial(kmsRegion, matDesc);
    ...
    public void testMatDescNull() {
        ...
        try {
            // Create new encryption materials.
            region2 = TestConfig.OSS_TEST_REGION;
        ...
        try {
            ...
            try {
                encryptionMaterials.addRegionDescMaterial(region2, null);
