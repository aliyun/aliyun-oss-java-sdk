...
public class CopyObjectTest extends TestBase {
	...
	public void testCopyExistingObject() {
		...
		try {
			...
			// Set source object different with target object and copy source bucket orignal
			...
			// Set source object same as target object and replace source bucket orignal
			// metadata.
			...
			CopyObjectRequest copyObjectRequest = new CopyObjectRequest(sourceBucket, sourceKey, sourceBucketAsTarget,
					sourceKeyAsTarget);
