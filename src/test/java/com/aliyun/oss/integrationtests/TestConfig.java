...
public final class TestConfig {
    ...
    public static String OSS_TEST_REGION = "oss-cn-hanzhou";
    ...
    public static String OSS_TEST_REPLICATION_ENDPOINT = "http://oss-cn-qingdao.aliyuncs.com";
    public static String OSS_TEST_REPLICATION_ACCESS_KEY_ID = OSS_TEST_ACCESS_KEY_ID;
    public static String OSS_TEST_REPLICATION_ACCESS_KEY_SECRET = OSS_TEST_ACCESS_KEY_SECRET;
