...
public class TestForImg extends TestCase {
	...
	private static OSS clientImg = new OSSClientBuilder().build(endpointImg, accessKeyId, accessKeySecret,
			new ClientBuilderConfiguration());
	private static OSS clientOss = new OSSClientBuilder().build(endpointOss, accessKeyId, accessKeySecret,
			new ClientBuilderConfiguration());
