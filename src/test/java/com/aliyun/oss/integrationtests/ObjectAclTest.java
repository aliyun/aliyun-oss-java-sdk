...
public class ObjectAclTest extends TestBase {
	...
	private static final CannedAccessControlList[] ACLS = { CannedAccessControlList.Default,
	...
	public void testCopyObjectWithACLHeader() throws IOException {
		...
		try {
			...
			CopyObjectRequest copyObjectRequest = new CopyObjectRequest(sourceBucket, sourceKey, targetBucket,
					targetKey);
