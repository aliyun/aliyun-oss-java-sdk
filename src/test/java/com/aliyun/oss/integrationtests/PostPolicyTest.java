...
public class PostPolicyTest extends TestBase {
	...
	public void testGenPostPolicy() {
		...
		try {
			...
			String expectedPostPolicy = String
					.format("{\"expiration\":\"2020-03-19T03:44:06.476Z\",\"conditions\":[{\"bucket\":\"%s\"},"
			...
			// String actualPostSignature =
			// ossClient.calculatePostSignature(actualPostPolicy);
