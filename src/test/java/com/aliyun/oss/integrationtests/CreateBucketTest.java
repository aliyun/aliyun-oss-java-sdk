...
public class CreateBucketTest extends TestBase {
	...
	public void testPutWithUnsupportedLocation() {
		final String bucketName = TestConfig.BUCKET_NAME_PREFIX + "bucket-with-unsupported-location";
	...
	public void testPutWithInconsistentLocation() {
		final String bucketName = TestConfig.BUCKET_NAME_PREFIX + "bucket-with-inconsistent-location";
	...
	public void testModifyExistingBucketLocation() {
		final String bucketName = TestConfig.BUCKET_NAME_PREFIX + "modify-existing-bucket-location";
	...
	public void testInvalidBucketNames() {
		String[] invalidBucketNames = { "ab", "abcdefjhijklmnopqrstuvwxyz0123456789abcdefjhijklmnopqrstuvwxyz-a", "abC",
				"abc#", "-abc", "#abc", "-abc-", "Abcdefg", "abcdefg-" };
	...
	public void testPutTooManyBuckets() {
		final String bucketNamePrefix = TestConfig.BUCKET_NAME_PREFIX + "too-many-buckets-";
	...
	public void testPutWithCannedACL() {
		final String bucketName = TestConfig.BUCKET_NAME_PREFIX + "bucket-with-canned-acl";
	...
	public void testPutWithDefaultStorageType() {
		final String bucketName = TestConfig.BUCKET_NAME_PREFIX + "bucket-with-default-storage-type";
	...
	public void testPutWithStorageType() {
		final String bucketName = TestConfig.BUCKET_NAME_PREFIX + "bucket-with-storage-type";
	...
	public void testPutWithStorageTypeFunc() {
		final String bucketName = TestConfig.BUCKET_NAME_PREFIX + "bucket-with-storage-type-func";
	...
	public void testPutWithStorageTypeAndLocation() {
		final String bucketName = TestConfig.BUCKET_NAME_PREFIX + "bucket-with-storage-and-location";
	...
	public void testPutWithStorageTypeModify() {
		final String bucketName = TestConfig.BUCKET_NAME_PREFIX + "bucket-with-storage-type-modify";
	...
	public void testPutWithWithStorageTypeUnsupportedLocation() {
		final String bucketName = TestConfig.BUCKET_NAME_PREFIX + "bucket-with-storage-unsupported-location";
		final String unsupportedLocation = "oss-cn-zhengzhou";
	...
	public void testPutWithStorageTypeCompatibility() {
		final String bucketName = TestConfig.BUCKET_NAME_PREFIX + "bucket-with-storage-type-compatibility";
