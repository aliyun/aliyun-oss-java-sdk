...
public class RequestTimeoutTest extends TestBase {
	...
	/**
	 * Negative test cases Reading a non-existing bucket, object. Uploading a null
	 * stream. Uploading an object with 1ms timeout value.
	 */
	@Test
	...
	/**
	 * Test operations after package loss. To simulate package eloss, we use
	 * iptables in linux and cut the network in windows.
	 */
	@Test
	...
	/**
	 * Multiple OSSClient instances test. Each instance should work independently
	 * without being impacted by other instances. So one timeout instance should not
	 * make other instances timeout.
	 *
	 */
	@Test
