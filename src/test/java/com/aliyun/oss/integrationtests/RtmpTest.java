...
public class RtmpTest extends TestBase {
	...
	public void testCreateLiveChannel() {
		...
		try {
			...
			CreateLiveChannelRequest createLiveChannelRequest = new CreateLiveChannelRequest(bucketName, liveChannel,
					liveChannelDesc, LiveChannelStatus.Disabled, target);
	...
	public void testGetLiveChannelInfo() {
		...
		try {
			LiveChannelTarget target = new LiveChannelTarget("HLS", 100, 99, "myplaylist.m3u8");
			CreateLiveChannelRequest createLiveChannelRequest = new CreateLiveChannelRequest(bucketName, liveChannel,
					liveChannelDesc, LiveChannelStatus.Enabled, target);
	...
	public void testGetLiveChannelStat() {
		...
		try {
			...
			// ./ffmpeg \-re \-i allstar.flv \-c copy \-f flv
			// "rtmp://oss-live-channel-2.demo-oss-cn-shenzhen.aliyuncs.com/live/normal-get-live-channel-stat?playlistName=playlist.m3u8"
			Thread.sleep(5 * 1000);
	...
	public void testGetLiveChannelHistory() {
		...
		try {
			...
			// Manually enable pusing streaming with following cmd:
			// ./ffmpeg \-re \-i allstar.flv \-c copy \-f flv
			// "rtmp://oss-live-channel-2.demo-oss-cn-shenzhen.aliyuncs.com/live/normal-get-live-channel-history?playlistName=playlist.m3u8"
			Thread.sleep(5 * 1000);
