...
public class EncryptionSm4ClientRsaTest extends TestBase {
    ...
    public void setUp() throws Exception {
        ...
        ossEncryptionClient = new OSSEncryptionClientBuilder().build(TestConfig.OSS_TEST_ENDPOINT,
                new DefaultCredentialProvider(credentials), encryptionMaterials, null, cryptoConfiguration);
    }
    ...
    public void testGetObjectToFileWithRangeGet() {
        try {
            ...
            String buffer2Str = new String(buffer2);
            System.out.println(buffer1Str);
            System.out.println(buffer2Str);
    ...
    public void testFindKeyByDescirtion() throws Throwable {
        try {
            ...
            CryptoConfiguration cryptoConfiguration = new CryptoConfiguration();
            cryptoConfiguration.setContentCryptoMode(ContentCryptoMode.SM4_CTR_MODE);
            OSSEncryptionClient ossEncryptionClient2 = new OSSEncryptionClientBuilder().build(TestConfig.OSS_TEST_ENDPOINT,
                    new DefaultCredentialProvider(credentials), encryptionMaterials, null, cryptoConfiguration);
            try {
                getObjectRequest = new GetObjectRequest(bucketName, key);
        ...
        try {
            for (int index = 0; index < encSourceList.size(); index++) {
                ...
                OSSEncryptionClient tmpOssEncryptionClient = new OSSEncryptionClientBuilder().
                        build(TestConfig.OSS_TEST_ENDPOINT, new DefaultCredentialProvider(credentials), encryptionMaterials, null, cryptoConfiguration);
    ...
    public void testGetFileWithWrongAlgo() {
        ...
        final Map<String, String> userMetaCpp = new HashMap<String, String>();
        userMetaCpp.put("x-oss-meta-client-side-encryption-cek-alg", "SM4/CTR/NoPadding");
        userMetaCpp.put("x-oss-meta-client-side-encryption-key",
                "nyXOp7delQ/MQLjKQMhHLaT0w7u2yQo"
                        + "DLkSnK8MFg/MwYdh4na4/LS8LLbLcM18m8I/ObWUHU775I50sJCpdv+f4e0jLeVRRiDFWe+uo7Pu"
                        + "c9j4xHj8YB3QlcIOFQiTxHIB6q+C+RA6lGwqqYVa+n3aV5uWhygyv1MWmESurppg=");
        ...
        try {
            ...
            CryptoConfiguration cryptoConfiguration = new CryptoConfiguration();
            cryptoConfiguration.setContentCryptoMode(ContentCryptoMode.SM4_CTR_MODE);
            OSSEncryptionClient tmpOssEncryptionClient = new OSSEncryptionClientBuilder().build(TestConfig.OSS_TEST_ENDPOINT,
                    new DefaultCredentialProvider(credentials), encryptionMaterials, null, cryptoConfiguration);
