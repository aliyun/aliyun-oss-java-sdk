...
public class CustomSessionCredentialsFetcherMock extends CustomSessionCredentialsFetcher {

    public CustomSessionCredentialsFetcherMock(String ossAuthServerHost) {
    ...
    private static final String NORMAL_WITHOUT_EXPIRATION_METADATA = "{"
            ...
            + "\"AccessKeySecret\" : \"CJ7G63EhuZuN8rfSg2Rd****qAgHMhmDuMkp****NPUV\"," + "\"StatusCode\" : \"200\""
            + "}";
    ...
    public CustomSessionCredentialsFetcherMock withResponseCategory(ResponseCategory responseCategory) {
