...
public class CRC64UtilTest {
    ...
    public void testCRC64() {
        ...
        Assertions.assertEquals(pat, crc64.getValue());
        ...
        Assertions.assertEquals(0, crc64.getValue());
        ...
        Assertions.assertEquals(crc3.getValue(), crc4.getValue());

        CRC64 crc5 = CRC64.combine(crc1, crc2, 0);
        Assertions.assertEquals(crc1.getValue(), crc5.getValue());

        Assertions.assertEquals(2, CRC64.combine(2, 3, 0));

        Assertions.assertTrue(crc4.getBytes().length > 0);
    }
}
