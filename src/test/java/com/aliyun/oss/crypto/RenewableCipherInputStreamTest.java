...
public class RenewableCipherInputStreamTest {
    ...
    public void testMarkAndRest() {
        ...
        try {
            ...
            Assertions.assertEquals(50, len3);
            Assertions.assertTrue(Arrays.equals(buffer, buffer3));
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void testMarkUnnromal() {
        ...
        try {
            ...
            isCurr.read();
            isCurr.mark(50);
            Assertions.fail("The RenewableCipherInputStream marking only supported for first call to read or skip.");
    ...
    public void testConstruction() {
        ...
        try {
            ...
            Assertions.fail("buff size if should multiple of 512.");
    ...
    public void testCipherInputStream() {
        ...
        Assertions.assertEquals(isCurr.markSupported(), false);
        try {
            isCurr.mark(10);
            isCurr.reset();
            Assertions.fail("{@link CipherInputStream} instance not support mark and reset.");
        } catch (Exception e) {
            // Expected excpetion.
        }
    }
