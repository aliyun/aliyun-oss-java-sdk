...
public class Sm4Ctr extends CryptoScheme {
    @Override public String getKeyGeneratorAlgorithm() {return "SM4";}
    @Override public int getKeyLengthInBits() {return 128;}
    @Override public String getContentChiperAlgorithm() {return "SM4/CTR/NoPadding";}
