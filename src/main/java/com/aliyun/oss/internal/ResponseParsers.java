...
//                if (root.getChildren("BucketDataRedundancyTransition") != null) {
//                    List<Element> transitionElems = root.getChildren("BucketDataRedundancyTransition");
//                    List<BucketDataRedundancyTransition> transitions = new ArrayList<BucketDataRedundancyTransition>();
//                    for (Element e : transitionElems) {
//                        BucketDataRedundancyTransition transition = new BucketDataRedundancyTransition();
//                        transition.setTaskId(e.getChildText("TaskId"));
//                        transition.setStatus(e.getChildText("Status"));
//                        transition.setCreateTime(e.getChildText("CreateTime"));
//                        transition.setStartTime(e.getChildText("StartTime"));
//                        transition.setEndTime(e.getChildText("EndTime"));
//                        if (null != element.getChild("Bucket")) {
//                            result.setBucket(element.getChildText("Bucket"));
//                        }
//                        if(!StringUtils.isNullOrEmpty(e.getChildText("EstimatedRemainingTime"))){
//                            transition.setEstimatedRemainingTime(Long.parseLong(e.getChildText("EstimatedRemainingTime")));
//                        }
//                        if(!StringUtils.isNullOrEmpty(e.getChildText("ProcessPercentage"))){
//                            transition.setProcessPercentage(Long.parseLong(e.getChildText("ProcessPercentage")));
//                        }
//                        transitions.add(transition);
//                    }
//                    listUserDataRedundancyTransitionResult.setBucketDataRedundancyTransition(transitions);
//                }
                return listUserDataRedundancyTransitionResult;
            } catch (JDOMParseException e) {
                throw new ResponseParseException(e.getPartialDocument() + ": " + e.getMessage(), e);
