...
public class SignUtils {
    ...
    private static final List<String> SIGNED_PARAMTERS = Arrays.asList(new String[] { SUBRESOURCE_ACL,
            ...
            SUBRESOURCE_NOTIFICATION, SUBRESOURCE_ENCRYPTION,SUBRESOURCE_WORM, SUBRESOURCE_WORM_ID, SUBRESOURCE_WORM_EXTEND, SUBRESOURCE_USER_REGION, SUBRESOURCE_REGION_LIST, SUBRESOURCE_NOTIFICATION,
            SUBRESOURCE_COMMENT });
