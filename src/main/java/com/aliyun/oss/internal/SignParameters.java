...
public class SignParameters {
    ...
    public static final List<String> SIGNED_PARAMTERS = Arrays.asList(new String[] { SUBRESOURCE_ACL,
            ...
            SUBRESOURCE_REGION_LIST, X_OSS_ASYNC_PROCESS, WRITE_GET_OBJECT_RESPONSE, ARCHIVE_DIRECT_READ,
            REDUNDANCY_TRANSITION, X_OSS_TARGET_REDUNDANCY_TYPE, X_OSS_REDUNDANCY_TRANSITION_TASK_ID});
